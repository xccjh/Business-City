...
<div style="margin-top: -50px">
	...
	<nav-bread>
		<span slot="orderConfirm">订单确认</span>
	</nav-bread>
  ...
  <div class="container">
    <div class="checkout-order">
      <div class="page-title-normal">
        ...
        <h2 class="page-title-h2" style="font-size: 20px;"><span>订单确认</span></h2>
      </div>
      <!-- process step -->
      ...
      <div class="page-title-normal checkout-title">
        ...
        <h2 style="text-align: center;"><span>订单内容</span></h2>
      </div>
      <div class="item-list-wrap confirm-item-list-wrap">
        <div class="cart-item order-item">
         ...
         <!-- <li>Order contents</li>
              ...
              <li>Quantity</li>
              <li>Subtotal</li> -->
              <li style="text-align: left; padding-left: 20px;">订单内容</li>
              <li>价格</li>
              <li>数量</li>
              <li>子商品总价</li>
            </ul>
            ...
            <li v-for="item in cartList" v-if="item.checked=='1'">
              ...
              <div class="cart-tab-3">
                <div class="item-quantity">
                  ...
                  <div class="item-stock item-stock-no">库存</div>
                </div>
              </div>
      ...
      <div class="order-foot-wrap">
        ...
        <div class="next-btn-wrap">
          ...
          <button class="btn btn--m btn--red" @click="payMent">去买单</button>
        </div>
      </div>
    </div>
  </div>

...
<div style="margin-top: -50px">
  <!--   //标志部分 -->
<svg style="position: absolute; width: 0; height: 0; overflow: hidden;" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://ww.w3.org/1999/xlink">
  <defs>
	...
	<nav-bread>
      <!-- <span slot="myCard">My Cart</span> -->
  		<span slot="myCard">购物车详情</span>
	</nav-bread>
<div class="container">
  <div class="cart">
      ...
      <div class="cart-item">
        <div class="cart-item-head">
          <ul>
            ...
            <li>Subtotal</li>
            <li>Edit</li> -->
            <li style="text-align: left;padding-left: 40px;">商品详情</li>
            <li>商品价格</li>
            <li>商品数量</li>
            <li>商品总价</li>
            <li>编辑</li>
    ...
    <div class="cart-foot-wrap">
      <div class="cart-foot-inner">
        <div class="cart-foot-l">
          ...
          <a href="javascipt:;" class="item-del-btn" style="vertical-align: middle;float: left; padding: 0 22px; line-height: 54px;" @click="delSelect">
            删除所选
          </a>
          </div>
        </div>
        ...
        <div class="cart-foot-r">
          ...
          <div class="btn-wrap">
            ...
            <a class="btn btn--red" :class="{'btn--dis':checkedCount==0}" @click="checkOut">&nbsp;&nbsp;&nbsp;去买单&nbsp;&nbsp;&nbsp;</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <modal :mdShow="modalConfirm" @close="closeModal">
    ...
    <div slot= "btnGroup">
      <a class="btn btn--m" href="javascript:;" @click="del(type)">确认</a>
...
<script type="text/javascript">
  ...
  export default {
    ...
    mounted() {
      ...
      del(type){
        if (type) {
        this.productId=this.delItem.productId;
        axios.post("/users/cartDel",{
          ...
          if(res.status == "0") {
            ...
            var num=0;
            axios.post("/users/delSelect").then((response)=> {
            let res =response.data;
            this.modalConfirm = false;
            this.init();
            this.cartList= res.result;

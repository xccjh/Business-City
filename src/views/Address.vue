...
<div style="margin-top: -50px">
  ...
  <div class="checkout-page">
    ...
    <div class="container">
        ...
        <div class="addr-list">
          <ul>
            ...
            <!-- 地址信息 -->
              ...
              <!-- 默认地址 -->
              <!-- <div class="addr-opration addr-default" v-if="item.isDefault">Default address
              </div> -->
              <div class="addr-opration addr-default" v-if="item.isDefault">默认地址
              </div>
            </li>
            <!-- 添加地址 -->
            <li class="addr-new">
      ...
      <div class="page-title-normal checkout-title">
        ...
        <h2><span>运送方式</span></h2>
      </div>
      <!-- <div class="lemall-msg-info hidden">
             <span>The region you selected is not within our delivery area. Please select another shipping address within our delivery areas.
               </span>
           </div> -->
      <!-- 购买方式框体 -->
        ...
        <div class="shipping-method">
          <ul>
            <li class="check">
              ...
              <div class="name">标准快递方式</div>
              <div class="price">免邮</div>
              <div class="shipping-tips">
                <p>发货后，一般情况下订单商品会在1-7个工作日到达目的地。</p>
              </div>
            </li>
          </ul>
        </div>
      ...
      <div class="next-btn-wrap">
        ...
        <router-link class="btn btn--m btn--red" :to="{path:'orderConfirm',query:{'addressId':selectAddrId}}">下一步</router-link>
  ...
  <modal :mdShow="isMdShow2" @close="isMdShow2=false">
    ...
    <div slot="btnGroup">
      <a class="btn btn--m" href="javascript:;" @click="isMdShow2=false">取消</a>
    </div>
  </modal>
